		...
		<div class="hm-main">	
			<div class="swiper-container" id="swiper-container1">
		        <div class="swiper-wrapper">
		            <div class="swiper-slide">
		            	<div class="recommendHtml">
		            		<div class="swiper-container" id="swiper-container2">
		            			<div class="swiper-wrapper">
		            				<!-- <div class="swiper-slide" v-for=" x in focusList " >
		            					<img :src="x.picUrl">
		            				</div> -->		            				
		            		...
		            		<!-- 	<div class="swiper-container rc-np-ul">
		       						<div class="swiper-wrapper">
		       							<div class="swiper-slide" v-for="x in newItemList">
		       							...
		       							<div class="swiper-slide rc-npMore">
	            							<p>查看全部</p>
		       							</div>
		       						</div>
		       					</div> -->
								...
								<ul class="rc-rcType-ul">
									<li v-for="x in items.itemList.slice(0,7)">
										<div class="rc-rcType-img">
											<span class="rc-rcType-img-color">5色可选</span>
		            ...
		            <div class="swiper-slide">
		            	<div class="timeHtml">限时购</div>
		            </div>
		            <div class="swiper-slide">
						<div class="timeHtml">居家</div>
		            </div>
		            <div class="swiper-slide">
	...
	export default{
		...
		mounted() {
			...
			this.swiper2 = new Swiper ('#swiper-container2', {	    	
				    ...
				    // onTouchStart : ()=>{
				    // 	console.log(1)
				    // 	this.swiper1.lockSwipes()
				    // }	   
			    });
			// this.swiper3 = new Swiper ('.rc-np-ul',{
			// 		autoplay: 2000,
			// 		nested : true,
			//     	resistanceRatio: 0
			//     });
...
/*	.rc-np-ul .swiper-slide{
	...
	.rc-np-ul .swiper-slide img{
		width: 100%;
		height: 110%;
		margin-bottom: 0.25rem;
	}
	.rc-np-ul .swiper-slide .rc-npName{
		font-size: 0.3rem;
	}*/
	/*原有样式*/
	.rc-np-ul{
